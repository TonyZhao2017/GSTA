...
from models import GlobalSpaceEncoder
from models import LocalEncoder
from models import MLPDecoder
from utils import TemporalData


class GSTA(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.local_encoder = LocalEncoder(historical_steps=historical_steps,
                                          ...
                                          parallel=parallel)
        self.global_encoder = GlobalSpaceEncoder(historical_steps=historical_steps,
                                                 embed_dim=embed_dim,
                                                 edge_dim=edge_dim,
                                                 num_modes=num_modes,
                                                 num_heads=num_heads,
    ...
    def forward(self, data: TemporalData):
        ...
        global_embed = self.global_encoder(data=data, local_embed=local_embed)
    ...
    def add_model_specific_args(parent_parser):
        parser = parent_parser.add_argument_group('GSTA')
